...
import { Trophy, Gem, ScrollText } from "lucide-react";
  ...
  return (
    <header className="sticky top-0 z-40 -mx-4 mb-2 flex items-center justify-between border-b border-surface-border/70 bg-surface-0/85 px-4 py-4 backdrop-blur sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
      <Link href="/" className="flex items-center">
        <span className="relative flex h-12 w-12 shrink-0 items-center justify-center drop-shadow-[0_0_10px_rgba(57,135,229,0.35)]">
          <Image src="/logo-rise-nav.png" alt={`${sideName} logo`} fill className="object-contain" priority />
        </span>
      </Link>
